...
function Expr() {}
___default["default"].extend(Expr.prototype, {
  ...
  recurse: function (method) {
    ...
    var args = ___default["default"].map(this.args(), function (arg) {
      return ___default["default"].isString(arg) ? arg : arg[method].apply(arg, passed);
    });
  ...
  repr: function () {
    return this.name() + "(" + ___default["default"].map(this.args(), function (arg) {
      return ___default["default"].isString(arg) ? arg : arg.repr();
    }).join(",") + ")";
  },
  ...
  exprArgs: function () {
    return ___default["default"].filter(this.args(), function (arg) {
...
___default["default"].extend(Seq.prototype, {
  args: function () {
    return this.terms;
  },
  normalize: function () {
    var terms = ___default["default"].sortBy(___default["default"].invoke(this.terms, "normalize"), function (term) {
      return term.print();
    });
  ...
  partition: function () {
    var terms = ___default["default"].groupBy(this.terms, function (term) {
  ...
  flatten: function () {
    var type = this;
    var terms = ___default["default"].reject(this.terms, function (term) {
    ...
    var grouped = ___default["default"].groupBy(terms, function (term) {
  ...
  replace: function (oldTerm, newTerm) {
    ...
    if (oldTerm instanceof Expr) {
      index = ___default["default"].indexOf(this.terms, oldTerm);
    } else {
      index = oldTerm;
    }
    var newTerms = [];
    if (___default["default"].isArray(newTerm)) {
      newTerms = newTerm;
    } else if (newTerm) {
      newTerms = [newTerm];
    }
...
function Add() {
  if (arguments.length === 1) {
    ...
    this.terms = ___default["default"].toArray(arguments);
  }
}
Add.prototype = new Seq();
___default["default"].extend(Add.prototype, {
  func: Add,
  eval: function (vars, options) {
    return ___default["default"].reduce(this.terms, function (memo, term) {
      return memo + term.eval(vars, options);
    }, 0);
  },
  codegen: function () {
    return ___default["default"].map(this.terms, function (term) {
      return "(" + term.codegen() + ")";
    }).join(" + ") || "0";
  },
  print: function () {
  ...
  tex: function () {
    var tex = "";
    ___default["default"].each(this.terms, function (term) {
  ...
  collect: function (options) {
    ...
    var pairs = [];
    ___default["default"].each(terms, function (term) {
    ...
    var grouped = ___default["default"].groupBy(pairs, function (pair) {
      return pair[0].normalize().print();
    });
    var collected = ___default["default"].compact(___default["default"].map(grouped, function (pairs) {
      var expr = pairs[0][0];
  ...
  factor: function (options) {
    ...
    ___default["default"].each(___default["default"].rest(this.terms), function (term) {
      factors = ___default["default"].map(factors, function (factor) {
    ...
    var remainder = ___default["default"].map(terms, function (term) {
...
___default["default"].extend(Mul.prototype, {
  func: Mul,
  eval: function (vars, options) {
    return ___default["default"].reduce(this.terms, function (memo, term) {
      return memo * term.eval(vars, options);
  ...
  getUnits: function () {
    var tmUnits = ___default["default"](this.terms).chain().map(function (term) {
  ...
  tex: function () {
    ...
    numbers = ___default["default"].compact(___default["default"].map(numbers, function (term) {
    ...
    if (numbers.length === 0 && others.length === 1) {
      ...
      var tex = "";
      ___default["default"].each(numbers, function (term) {
      ...
      ___default["default"].each(others, function (term) {
  ...
  strip: function () {
    var terms = ___default["default"].map(this.terms, function (term) {
  ...
  expand: function () {
    ...
    var hasAdd = ___default["default"].any(mul.terms, isAdd);
    var hasInverseAdd = ___default["default"].any(mul.terms, isInverseAdd);
    if (!(hasAdd || hasInverseAdd)) {
      return mul;
    }
    var terms = ___default["default"].groupBy(mul.terms, isInverse);
    var normals = terms[false] || [];
    var inverses = terms[true] || [];
    if (hasAdd) {
      var grouped = ___default["default"].groupBy(normals, isAdd);
      var adds = grouped[true] || [];
      var others = grouped[false] || [];

      // loop over each additive sequence
      var expanded = ___default["default"].reduce(adds, function (expanded, add) {
        ...
        return ___default["default"].reduce(expanded, function (temp, array) {
          ...
          return temp.concat(___default["default"].map(add.terms, function (term) {
      ...
      var muls = ___default["default"].map(expanded, function (array) {
        return new Mul(others.concat(array)).flatten();
      });
      normals = [new Add(muls)];
    }
    if (hasInverseAdd) {
      var denominator = new Mul(___default["default"].invoke(inverses, "getDenominator")).flatten();
  ...
  factor: function (options) {
    ...
    var grouped = ___default["default"].groupBy(factored.terms, function (term) {
    ...
    var rational = ___default["default"].reduce(grouped[true], function (memo, term) {
      return {
        n: memo.n * term.n,
        d: memo.d * term.d
      };
  ...
  collect: function (options) {
    ...
    // [[Expr base, Expr exp]]
    var summed = ___default["default"].compact(___default["default"].map(grouped, function (pairs) {
      var base = pairs[0][0];
      var sum = new Add(___default["default"].zip.apply(___default["default"], pairs)[1]);
    ...
    var pairs = ___default["default"].groupBy(summed, function (pair) {
    ...
    if (trigs.length > 1) {
      ...
      var byArg = ___default["default"].groupBy(trigs, function (pair) {
        return pair[0].arg.normalize().print();
      });
      trigs = [];
      ___default["default"].each(byArg, function (pairs) {
        ...
        ___default["default"].each(pairs, function (pair) {
        ...
        ___default["default"].each(funcs, function (exp, type) {
    ...
    if (logs.length > 1) {
      ...
      var byBase = ___default["default"].groupBy(logs, function (pair) {
        return pair[0].base.normalize().print();
      });
      logs = [];
      ___default["default"].each(byBase, function (pairs) {
    ...
    var collected = ___default["default"].map(pairs, function (pair) {
      return new Pow(pair[0], pair[1]).collect(options);
    });
    return new Mul([number].concat(collected)).flatten();
  },
  isSubtract: function () {
    return ___default["default"].any(this.terms, function (term) {
  ...
  factorIn: function (hint) {
    ...
    var fold = numbers.length && ___default["default"].all(numbers, function (num) {
      return num.n > 0;
    });
    if (fold) {
      // e.g. - x*2*3 -> x*-2*3
  ...
  factorOut: function () {
    var factored = false;
    var terms = ___default["default"].compact(___default["default"].map(this.terms, function (term, i, list) {
  ...
  asPositiveFactor: function () {
    if (this.isPositive()) {
      ...
      var terms = ___default["default"].invoke(this.collect().terms, "asPositiveFactor");
      return new Mul(terms).flatten();
    }
  },
  isNegative: function () {
    return ___default["default"].any(___default["default"].invoke(this.collect().terms, "isNegative"));
  },
  fold: function () {
  ...
  negate: function () {
    ...
    if (___default["default"].any(this.terms, isNum)) {
      var num = ___default["default"].find(this.terms, isNum);
...
___default["default"].each([Add, Mul], function (type) {
  ___default["default"].extend(type, {
...
___default["default"].extend(Mul, {
  ...
  handleDivide: function (left, right) {
    ...
    if (isInt(right) && left instanceof Mul && ___default["default"].any(left.terms, isInt)) {
      ...
      var num = ___default["default"].find(reversed, isRational);
      if (!isInt(num)) {
  ...
  fold: function (expr) {
    if (expr instanceof Mul) {
      ...
      var trigLog = ___default["default"].find(___default["default"].initial(expr.terms), function (term) {
        return (term instanceof Trig || term instanceof Log) && term.hints.open;
      });
      var index = ___default["default"].indexOf(expr.terms, trigLog);
      if (trigLog) {
        var last = ___default["default"].last(expr.terms);
      ...
      if (numbers.length > 1 && ___default["default"].some(numbers, neg) && ___default["default"].some(numbers, pos) && ___default["default"].every(numbers, posOrNeg)) {
        var firstNeg = ___default["default"].indexOf(expr.terms, ___default["default"].find(expr.terms, neg));
        var firstNum = ___default["default"].indexOf(expr.terms, ___default["default"].find(expr.terms, pos));
...
___default["default"].extend(Pow.prototype, {
  func: Pow,
  args: function () {
  ...
  expand: function () {
    ...
    if (pow.base instanceof Mul) {
      ...
      var terms = ___default["default"].map(pow.base.terms, function (term) {
      ...
      if (___default["default"].has(cache, n)) {
        return signed(cache[n]);
      }

      // otherwise decompose n into powers of 2 ...
      var indices = ___default["default"].map(n.toString(2).split(""), function (str, i, list) {
        return Number(str) * Math.pow(2, list.length - i - 1);
      });
      indices = ___default["default"].without(indices, 0);

      // ... then combine
      var mul = new Mul(___default["default"].pick(cache, indices)).expand().collect();
      return signed(mul);
    } else if (pow.exp instanceof Add) {
      // DEFINITELY want behind super-simplify() flag
      // e.g. x^(a+b) -> x^a*x^b

      var terms = ___default["default"].map(pow.exp.terms, function (term) {
  ...
  collect: function (options) {
    ...
    if (pow.exp instanceof Num && pow.exp.eval() === 0) {
      ...
      var log = ___default["default"].find(pow.exp.terms, isSimilarLog);
      var base = log.power;
...
___default["default"].extend(Log.prototype, {
  func: Log,
  args: function () {
  ...
  expand: function () {
    ...
    if (log.power instanceof Mul) {
      ...
      var terms = ___default["default"].map(log.power.terms, function (term) {
  ...
  hints: ___default["default"].extend(Log.prototype.hints, {
    open: false
  }),
  isPositive: function () {
...
___default["default"].extend(Trig.prototype, {
  func: Trig,
  args: function () {
  ...
  hints: ___default["default"].extend(Trig.prototype.hints, {
    open: false
  }),
  isPositive: function () {
...
___default["default"].extend(Trig, {
...
___default["default"].extend(Abs.prototype, {
  func: Abs,
  args: function () {
    return [this.arg];
  },
  ...
  collect: function (options) {
    ...
    if (abs.arg.isPositive()) {
      ...
      // e.g. |-2*pi*x| -> 2*pi*|x|
      var terms = ___default["default"].groupBy(abs.arg.terms, function (term) {
        if (term.isPositive()) {
          return "positive";
        } else if (term instanceof Num) {
          return "number";
  ...
  expand: function () {
    ...
    if (abs.arg instanceof Mul) {
      // e.g. |xyz| -> |x|*|y|*|z|
      var terms = ___default["default"].map(abs.arg.terms, function (term) {
        return new Abs(term);
      });
      return new Mul(terms);
    } else {
...
___default["default"].extend(Eq.prototype, {
  func: Eq,
  args: function () {
  ...
  asExpr: function (unfactored) {
    ...
    for (var i = 0; i < terms.length; i++) {
      ...
      if (!denominator.equals(Num.One)) {
        terms = ___default["default"].map(terms, function (term) {
  ...
  divideThrough: function (expr) {
    ...
    var grouped = ___default["default"].groupBy(terms, isAdd);
    var adds = grouped[true] || [];
    var others = grouped[false] || [];
    ...
    denominator = ___default["default"].map(denominator, function (term) {
...
___default["default"].extend(Symbol.prototype, {
  needsExplicitMul: function () {
    return false;
  },
  findGCD: function (factor) {
...
___default["default"].extend(Func.prototype, {
  func: Func,
  args: function () {
...
___default["default"].extend(Var.prototype, {
  func: Var,
  args: function () {
...
___default["default"].extend(Const.prototype, {
  func: Const,
  args: function () {
    return [this.symbol];
  },
...
___default["default"].extend(Num.prototype, {
  repr: function () {
    return this.print();
  },
  strip: function () {
  ...
  hints: ___default["default"].extend(Num.prototype.hints, {
    negate: false,
    subtract: false,
    divide: false,
    root: false,
...
___default["default"].extend(Rational.prototype, {
  func: Rational,
  args: function () {
...
___default["default"].extend(Int.prototype, {
  func: Int,
  args: function () {
    return [this.n];
  },
...
___default["default"].extend(Float.prototype, {
  func: Float,
  args: function () {
    return [this.n];
  },
...
___default["default"].extend(Float, {
  create: function (n) {
...
___default["default"].extend(Num, {
  ...
  min: function () {
    return ___default["default"].min(___default["default"].toArray(arguments), function (num) {
      return num.eval();
    });
  },
  max: function () {
    return ___default["default"].max(___default["default"].toArray(arguments), function (num) {
      return num.eval();
    });
  }
});
...
var unprefixify = function (symbol) {
  ...
  // check for prefix
  var prefix = ___default["default"](___default["default"](siPrefixes).keys()).find(function (testPrefix) {
...
const unitParse = function (input) {
  try {
    ...
    var unitArray = [];
    ___default["default"](parseResult.unit.num).each(function (unitSpec) {
      unitArray.push(new Pow(unprefixify(unitSpec.name), new Int(unitSpec.pow)));
    });
    ___default["default"](parseResult.unit.denom).each(function (unitSpec) {
...
___default["default"].extend(Unit.prototype, {
  func: Unit,
  args: function () {
    return [this.symbol];
  },
...
const compare = function (expr1, expr2, options) {
  ...
  if (options !== undefined) {
    ...
    options = ___default["default"].extend(defaults, options);
  } else {
    options = defaults;
  }
